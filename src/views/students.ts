          ...
          try {
            ...
            if (d && d.isValid) {
              ...
              const matchBadge = isMatch === true
                ...
                ? '<span class="badge bg-success rounded-pill px-3 py-1">âœ… Cocok 100% dengan DB</span>'

                : (isMatch === false ? '<span class="badge bg-warning text-dark rounded-pill px-3 py-1">âš ï¸ Beda dengan DB</span>' : '<span class="badge bg-secondary rounded-pill px-3 py-1">DB Belum Terisi</span>');

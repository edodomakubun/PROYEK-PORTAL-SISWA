...
export function renderPrintCardsPage(students, classesList, selectedClass) {
    ...
    const classOptions = classesList.map(cls => `<option value="${cls}" ${selectedClass === cls ? 'selected' : ''}>${cls}</option>`).join('');
    return `<!DOCTYPE html>
<html lang="id">
<head>
  <meta charset="UTF-8">
